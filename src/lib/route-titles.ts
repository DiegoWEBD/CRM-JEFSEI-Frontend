...
export const RUTAS_PRINCIPALES: RouteMeta[] = [
	...
	{ href: '/solicitudes-estudio', titulo: 'Solicitudes de estudio', icono: FileSearch },
	{ href: '/cotizaciones-estudios-emitidos', titulo: 'Cotizaciones / estudios', icono: FileCheck },
...
export function tituloDeRuta(pathname: string): string {
	const sorted = [...RUTAS_PRINCIPALES].sort((a, b) => b.href.length - a.href.length)
