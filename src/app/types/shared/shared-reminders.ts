...
export type SharedReminderPriority = 'baja' | 'normal' | 'alta'
...
export const prioridadReminderStyles: Record<SharedReminderPriority, string> = {
	baja: 'border-slate-500/35 bg-slate-500/10 text-slate-900 dark:text-slate-100',
...
export function prioridadRecordatorio(
	reminder: SharedReminder,
): SharedReminderPriority {
	return reminder.prioridad ?? 'normal'
}
