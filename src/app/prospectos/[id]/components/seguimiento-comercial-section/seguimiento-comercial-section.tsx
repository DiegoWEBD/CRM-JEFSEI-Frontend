...
const ESTADO_CONTACTO_PROXIMA_ACCION: Record<string, string> = {
  ...
  'no interesado por ahora': 'Se registrará como frío y se contactará en 30 días.',
...
export default function SeguimientoComercialSection({
  ...
  const formikAgendar = useFormik({
    ...
    validationSchema: Yup.object({
      ...
      tipo: Yup.string()
        .oneOf(
          TIPOS_RECORDATORIO as unknown as string[],
          'Selecciona un tipo',
        )
        .required(),
    }),
            ...
            <div className='space-y-4'>
              ...
              {historial.length > 0 ? (
                ...
                <p className='text-xs text-muted-foreground'>
                  {puedeEditar
                    ? 'Aún no hay gestiones registradas. Usa «Registrar gestión comercial» para iniciar el seguimiento.'
            ...
            <div className='space-y-3'>
              ...
              <div className='space-y-1.5'>
                ...
                <Select
                  ...
                  onValueChange={(v) =>
                    formikGestion.setFieldValue('tipo', v)
                  }
                >
            ...
            <div className='space-y-3'>
              <div className='space-y-1.5'>
                ...
                <Select
                  ...
                  onValueChange={(v) =>
                    formikAgendar.setFieldValue('tipo', v)
                  }
                >
                  <SelectTrigger className='h-9 text-xs'>
                    <SelectValue />
