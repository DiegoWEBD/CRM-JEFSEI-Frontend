        ...
        <form onSubmit={formik.handleSubmit} className='space-y-3'>
          <div className='space-y-1.5'>
            ...
            {formik.errors.id_company && formik.touched.id_company && (
              <p className='text-xs font-medium text-destructive'>{formik.errors.id_company}</p>
            )}
          </div>
          ...
          <div className='space-y-1.5'>
            ...
            {formik.errors.monto_total_asegurado && formik.touched.monto_total_asegurado && (
              <p className='text-xs font-medium text-destructive'>{formik.errors.monto_total_asegurado}</p>
            )}
          </div>
          ...
          <div className='grid gap-3 sm:grid-cols-3'>
            <div className='space-y-1.5'>
              ...
              {formik.errors.tasa_afecta && formik.touched.tasa_afecta && (
                <p className='text-xs font-medium text-destructive'>{formik.errors.tasa_afecta}</p>
              )}
            </div>
            <div className='space-y-1.5'>
              ...
              {formik.errors.tasa_excenta && formik.touched.tasa_excenta && (
                <p className='text-xs font-medium text-destructive'>{formik.errors.tasa_excenta}</p>
              )}
            </div>
            <div className='space-y-1.5'>
              ...
              {formik.errors.tasa_politica && formik.touched.tasa_politica && (
                <p className='text-xs font-medium text-destructive'>{formik.errors.tasa_politica}</p>
              )}
            </div>
          </div>
          ...
          <div className='space-y-1.5'>
            ...
            {formik.errors.prima_adicional_asistencia && formik.touched.prima_adicional_asistencia && (
              <p className='text-xs font-medium text-destructive'>{formik.errors.prima_adicional_asistencia}</p>
            )}
          </div>
          ...
          <div className='grid gap-3 sm:grid-cols-2'>
            <div className='space-y-1.5'>
              ...
              <Input type='date' className='h-9 text-sm' {...formik.getFieldProps('fecha_emision')} />
              {formik.errors.fecha_emision && formik.touched.fecha_emision && (
                <p className='text-xs font-medium text-destructive'>{formik.errors.fecha_emision}</p>
              )}
            </div>
            <div className='space-y-1.5'>
              <Label className='text-xs'>Fecha de vencimiento</Label>
              <Input type='date' className='h-9 text-sm' {...formik.getFieldProps('fecha_vencimiento')} />
